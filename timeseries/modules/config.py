...
DATA = 'combined_df'# 'df_0_einzel_aut'
...
ORIGINAL_PATH = '../resource_data/original/'
MODELS_PATH = '../resource_data/models/'
# SAVE_PLOTS_RESULTS_PATH = '../../../../Latex/bhtThesis/Masters/6_conclusion/pictures/'
SAVE_PLOTS_RESULTS_PATH_LSTM = '../plots/LSTM/'
SAVE_PLOTS_RESULTS_PATH_BASE = '../plots/Base/'